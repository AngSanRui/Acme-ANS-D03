...
public class FlightCrewMemberActivityLogShowService extends AbstractGuiService<FlightCrewMember, ActivityLog> {
	...
	public void authorise() {
		...
		status = assignment != null && this.repository.existsFlightCrewMember(flightCrewMemberId) && assignment != null && (super.getRequest().getPrincipal().hasRealm(assignment.getFlightCrewMember()) || !assignment.getDraftMode());
